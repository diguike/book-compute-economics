...
本章是议题 3「算力是真紧缺还是英伟达营销叙事」的主答辩章。给出的回答是——**结构性紧缺真实存在，但 2026 末-2027 上半年会看到第一次明显宽松**——这个回答有事实层（HBM4 / CoWoS / Hopper / ASIC 四股缓解力的物理基础）、有分析层（四股力同步发生的时间窗口推演）、有预测层（三个可证伪的早期信号）。这三层论据将作为议题 3 五段式答辩的输入素材。
