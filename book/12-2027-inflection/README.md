...
这是与卖方研报最大的姿态差别。卖方研报通常预测对了就拿出来表彰，预测错了就装作没说过；下面直接把预测的时间和阈值钉死在桌面上，让读者两年后回头能直接打分。需求侧弹性、杰文斯悖论、训推三段留到下一章展开。
...
第二层（分析层）。把四件事的时点拼起来，2026-Q4 至 2027-Q2 是供给侧第一次出现多个瓶颈同步缓解的窗口。HBM4 三家同步出货意味着英伟达从 SK 海力士独家供应 + 美光二供变成三供同台，议价权从供方端略微回到英伟达端；CoWoS 月产能从 80K 爬到 130K（业内估算 2026 中到 2026 末）意味着英伟达出货的物理上限抬升约 60%；Hopper 二手市场在 Blackwell 大规模交付后（2025-Q4 起进入量产、2026 全年放量）开始释放有效供给——这一项后面 §12.5 单独展开；ASIC 分流（Anthropic 1GW+ TPU 已签、AWS Trainium2 集群上线、Meta MTIA 部署）让 NVDA 队列里的有效需求出现结构性分流。四件事任何一件单独发生都不构成结构性缓解，但四件事同步发生在 2026-Q4 至 2027-Q2，量级足够形成第一次可被市场识别的紧缺缓解。
...
这不等于预测算力将永久过剩。供给侧的缓解之后，需求侧弹性（杰文斯 / reasoning 推理 / 后训练 RL）会接住部分释放出来的产能——这是下一章的话题。这里只论证供给侧的物理缓解：**2026 末-2027 上半年这个时间窗口里，HBM / CoWoS / Hopper 三个层面的有效供给都会有非线性的增加**。
...
本章只写供给侧缓解。需求侧的故事——杰文斯悖论、reasoning 推理对 token 需求的非线性拉升、训练算力 vs 推理算力的分段——在下一章「供给缓解之后：需求弹性能不能接住」里展开。

供给侧缓解 + 需求侧弹性，共同收束反共识 #4——「推理算力主导 2027 之后才成立」。供给侧基础在本章：2027 之前，训练侧需求仍然由英伟达 + ASIC 双轨承接，HBM4 / CoWoS / Hopper 二手 / ASIC 分流四股缓解力让训练侧不再是无法满足的需求。需求侧的真相留给下一章——推理侧需求在 reasoning + 后训练 RL 拉动下，可能在 2027 年中之后开始超过训练侧，成为算力市场的主导。这两件事拼起来：2027 之后，训练侧紧缺被缓解力承接、推理侧紧缺被需求弹性拉起，整个算力市场的紧缺中心从训练侧迁移到推理侧。
...
本章是议题 3「算力是真紧缺还是英伟达营销叙事」在后续 12 议题答辩章的主答辩位。给出的回答是——**结构性紧缺真实存在，但 2026 末-2027 上半年会看到第一次明显宽松**——这个回答有事实层（HBM4 / CoWoS / Hopper / ASIC 四股缓解力的物理基础）、有分析层（四股力同步发生的时间窗口推演）、有预测层（三个可证伪的早期信号）。这三层论据将作为议题 3 五段式答辩的输入素材。
...
把预测条件钉死在桌面上的姿态，是这本书与卖方研报、财经媒体在方法论上的分界线。卖方研报通常不写如果错了我们就承认错了，财经媒体通常不写两年后回来看这篇我们打几分。章末立此存照同时也是对读者的承诺与对作者的约束。
