---
title: "第 31 章 12 个争议的论证：可证伪条件五段式"
...
last_synced: "2026-08-18T20:59:18+08:00"
status: finalized
---
...
一个判断如果没法被证明是错的，它就不是判断，只是表态。

关于 AI 算力的争论已经吵了三年，多空双方各有一套完整说辞，谁也说服不了谁。问题出在双方给的都是观点，不是可以被现实检验的命题。「AI 资本支出过度了」——过度到什么程度算过度？多久之后见分晓？什么数字出现算你说对了、什么数字出现算你说错了？这些不说清楚，争论就只能一直吵下去。

下面 12 个具体争议，每一个都按同一套五步走：把争议问准确 → 乐观派怎么说（挂一手出处）→ 悲观派怎么说（挂一手出处）→ 数据说了什么、本书站哪一边 → **什么信号出现就算本书判断错了**。

12 个争议里，6 个本书给明确站位，6 个给分情况判断（「在什么条件之下倾向哪一边」）。
...
明确站位的 6 个（1 / 2 / 3 / 6 / 7 / 8），站位后面必须挂一个可观测的信号——信号到了，就是本书错了。分情况判断的 6 个（4 / 5 / 9 / 10 / 11 / 12），本书拒绝给单点结论，只给「哪个阈值之下倾向哪一边」，而阈值必须是数字、时间窗、监测来源三件套。

**这第五步，是这本书和卖方研报、媒体专栏、行情号之间真正的分界线。** 任何对 AI 算力周期的判断，如果没法被某个具体的、可监测的、有时间窗口的信号推翻，那它就只是观点。波普尔在《科学发现的逻辑》里早把这话说尽了——不可证伪的陈述不是错的，它根本就不在科学的范畴之内。

所以这一章卖的不是结论，是一套判断方法。读者可以拿它当一份追踪清单，逐季度核对作者的判断到底兑没兑现。
...
其中议题 9 至 12 直接涉及具体公司的估值含义，议题 1 和 4 间接涉及。这部分只做产业分析，不构成投资建议，也不披露持仓（全书统一规则见前言）。
...
- **两派各自的代表观点，都要挂一手出处**：不允许「业内观点」「分析师认为」这种隐身的论断。每一派必须挂上具体人 + 时点 + 一手出处。这是产业研究的最低门槛。
...
最后一点关于反身性——这是 Soros 在《金融炼金术》里反复强调的。当判断本身会影响被判断对象的行为时（例如「市场判断 [英伟达](https://www.nvidia.com/) 已透支」会触发抛售，进而真的让估值下行），任何点估计都很可能是错的。所以条件式表态在金融市场里不是回避，是诚实。
...
graph TD
    Issue[第一步 把争议问准确]
    Bull[第二步 乐观派观点<br/>挂一手出处]
    Bear[第三步 悲观派观点<br/>挂一手出处]
    Data[第四步 摆数据 给判断]
    Falsify[第五步 证伪条件<br/>数字 + 时间窗 + 监测来源]
...
**代表 2**：[Michael Burry](https://en.wikipedia.org/wiki/Michael_Burry)（Scion Asset Management），2025-09-30 13F 披露对 NVDA \$187M、Palantir \$912M 名义价值 put 仓位；2025-11 在 X / Cassandra Unchained 上发起对超大规模云厂折旧政策的攻击。核心攻击点：GPU 实际使用寿命 18-24 个月，但 Meta / Microsoft 在用 5-6 年折旧——人为压低折旧、虚增利润。本书第 16 章 §6 已量化测算：Burry 论点把 [CoreWeave](https://www.coreweave.com/) Operating margin 从 16% 推到 -30%。
...
注：表内 telecom 1999 历史数据（AT&T ~21%、WorldCom ~30%）来源为 Richmond Fed "Boom and Bust in Telecommunications"（Wolman 2003）+ AT&T FY99 财报 + WorldCom FY99 财报（本书 sources.md / 第 29 章 §29.3 已全文引用，此处重述以便第 31 章独立阅读）。表内 OpenAI 年化经常性收入 \$20B 来源为 The Information 2025-11 报道 OpenAI FY25 年化经常性收入 \$20B（本书第 29 章已引用）；Anthropic 年化经常性收入 \$30B 来源为本书第 29 章 / 第 16 章已交叉验证的 Anthropic 2026-Q1 年化经常性收入披露口径。
...
> CoreWeave Operating margin 从 +16% 推到 -30%、合计变化 -46 个百分点（第 16 章 §6 测算）；超大规模云厂 2026-2028 Hopper 累计低估折旧 \$176B（第 16 章 §6.3 测算）；Meta / MSFT 自由现金流/营收各压缩 20-25 个百分点（第 16 章 §6 测算）。
...
2. 终端 AI 真实收入 \$150B 量级与 Cahn 算法要求的 \$600B 之间，存在 \$450B 量级缺口——但这个缺口在杰文斯悖论起作用的窗口期内可以被「单价下降 × 量上升」对冲（详见议题 6 论证）。本书的判断是：18-36 个月内悖论占主导，更远期触及预算天花板。
3. 与 telecom 1999 的关键差异（详见第 29 章 §29.5）：Mag7 用自有自由现金流覆盖，不依赖 vendor financing；终端使用量真实（ChatGPT 周活 7-10 亿区间，其中 8 亿为 2025-10 时点的 OpenAI CEO 公开披露；Anthropic 年化经常性收入 \$30B，Menlo Ventures 2025-12 报告显示企业 AI 支出 2025 年 \$37B vs 2024 \$11.5B、3.2x 增长，来源：Menlo Ventures "2025: The State of Generative AI in the Enterprise" 2025-12-09）。这两个差异让本轮周期顶部比 telecom 更迟出现、但崩盘形态可能更接近页岩油（一根价格线扫边际玩家），而非 telecom（综合多因素崩盘）。

整合本书第 29 章 / 第 16 章 / 第 18 章已完成的分析——本书的位置不是「过度因此必崩」也不是「不过度可以一直加」，而是「**周期内仍有空间，但资本支出 / 营收 33%+ 是历史警戒线、需要监测真实终端付费的兑现速度**」。

### 什么信号出现，就算本书判断错了

本书在议题 1 上的判断「周期内仍有空间」证伪条件：

**触发器 A（财务侧）**：Mag7 合计自由现金流转负且持续 4 个季度——即 Mag7 加权自由现金流在 2027 年内连续四季度为负值。监测来源：四大超大规模云厂季报现金流量表，按季度计算经营现金流 - 资本支出。当前（2026-Q1）Mag7 合计自由现金流仍为正 ~\$100B 年化（详见第 29 章 §29.3 维度 8）；如降至负值并持续四季度，「周期内仍有空间」判断证伪。
...
**触发器 C（终端兑现侧）**：OpenAI / Anthropic 合计年化经常性收入在 2027 年底前增速从当前 +100%+ 降至 +30% 以下，并持续两季度。监测来源：The Information / CNBC 报道的 OpenAI / Anthropic 季度年化经常性收入披露；OpenAI 年化经常性收入 \$20B (FY25 末) 基线来自 The Information 2025-11 报道（本书第 29 章已引用）；Anthropic 年化经常性收入 \$30B (2026-Q1) 基线来自本书第 29 章 / 第 16 章已交叉验证版本。如最新披露与本书基线有出入，以 sources.md 数据缺口说明为准。
...
**代表 4**：Michael Burry（Scion），2025-11 折旧攻击系列。Burry 攻击点直指 dotcom 时代的会计争议——超大规模云厂用 5-6 年折旧 vs 实际 2-3 年使用寿命，2026-2028 累计低估折旧 \$176B（本书第 16 章 §6.3 测算）。

### 数据说了什么，本书站哪一边

把第 29 章 §29.2 的 12 维度对照表压缩到议题 2：
...
注：维度 2 telecom 1999 历史数据（AT&T ~21%、WorldCom ~30%）来源为 Richmond Fed "Boom and Bust in Telecommunications"（Wolman 2003）+ AT&T / WorldCom FY99 财报；其余 12 维度对照的 telecom 侧数据来源为 Richmond Fed 同篇 + 本书第 29 章 §29.2 / §29.3 已全文引用的 telecom 1999 历史数据集（含 FCC ARMIS 数据、Lucent / Nortel 财报、TeleGeography fiber 部署数据）。AI 2026 侧数据来源为 Mag7 FY25 10-K + NVDA FY26 10-K + Menlo Ventures 2025-12 + TrendForce 2025-2026 各章节已交叉验证版本（本书第 29 章 §29.3 已全文索引）。

12 维度中相似 ~6 个（维度 1 / 2 / 3 / 5 + 维度 4 / 10 部分相似），不相似或反向 ~6 个（维度 6 / 7 / 8 / 9 / 11 + 维度 12 是结论维度不算）。本书第 29 章 §29.3 已逐维度展开。
...
- 客户集中度（英伟达 FY26 年报前两大客户合计 36%、FY26 Q2 季报 39%，前四大约 61%，最大单一客户 22%；议题 9 详述）是新增的反身性风险。
...
本书「1997 末-1998 中期」定位的证伪条件——使用第 29 章 §29.7 三预警的简化版本：
...
**触发器 B**：NVDA 数据中心营收环比首次负增长（即任一季度数据中心收入 < 前一季度）。监测来源：NVDA 季度 10-Q 业务分部披露。NVDA 数据中心分部营收 **FY26 全年 \$193.7B**（NVDA FY26 10-K，2026-02-25 披露；本书第 12 章已详细引用）、季度环比仍 +15-25%——任何一季度环比转负即触发。
...
**三选二触发即证伪**——本书「1997 末-1998 中期」定位修正为「周期顶部已确认、进入 1999 末-2000 当量」，对应到第 29 章 §29.7 的「三预警全部出现」状态。

边界——单独触发器 A 可能因 Blackwell 出货量翻番带动 Hopper 自然降级到二手市场而出现（这是第 12 章已预测的 2027 拐点机制之一），需配合触发器 B 或 C 才确认。
...
**代表 3**：产业链供给端数据——[台积电](https://www.tsmc.com/) CoWoS 2025-2026 月产能从 2025 年 Q1 ~3 万片晶圆爬升到 Q4 ~4 万片仍供不应求；[SK 海力士](https://www.skhynix.com/) / 三星 / 美光（Micron） HBM4 三家同步给 NVDA 送样、2026-Q1 finalize 合同。供给端在抢——这本身就是紧缺的证明。
...
| SK 海力士 HBM 年产能 | ~600K 晶圆 | ~1M 晶圆 | 是 | 与 NVDA 锁单同步 |
| H100/H200 单卡供给 | 持续放量 | 紧 → 松 | 临界 | 2026 末进入二手降价 |
| GB200 NVL72 整柜 | 启动 | 大规模交付 | 是 | 2027 前持续紧 |
| 美国数据中心电力 | 已紧 | 更紧（PJM +12 GW） | 是 | 2028 前无解 |

本书那条「HBM 的真实价值高于 GPU 裸片」的判断，在这个议题上集中体现：HBM 单位价值占 H100 整卡 BOM 的 ~50%（第 1 章与第 6 章已交叉验证），但市场叙事仍以「GPU = NVDA」为主——这是真紧缺的核心位置被市场低估的代表案例。

**本书的明确表态**：

结构性紧缺真实存在，**但 2026 末-2027 初会出现第一次明显宽松**。三个理由：

1. HBM4 三家供给同步爬坡，三星在抢份额会主动让价（详见议题 11，以及第 6 章讲过的客户认证准入墙裂缝）；
...
**触发器 B**：台积电 CoWoS 月产能 2027 年中仍 < 60K 晶圆，且 NVDA / AMD / 博通（Broadcom） 仍排队抢——即如果产能爬升不及预期，本书「2026 Q4 起明显缓解」判断错误。监测来源：台积电季度财报电话会 Capital Markets Day 披露 + TrendForce 月度跟踪。

**触发器 C**：HBM4 12-Hi 在 2026 年底前未实现三家任一家月产能 > 50K stack——即如果 HBM4 爬坡延后到 2027，本书的紧缺缓解判断需要往后移半年到一年。监测来源：SK 海力士 / 三星 / 美光季报 + TrendForce HBM 月度报告。
...
Google 拿下 Anthropic 1M TPU 大单，AWS Project Rainier 启动 Trainium2 集群（业内估算 ~500K 颗量级，来源：Data Center Dynamics 2025-11 报道；本书无法直连验证一手，按 data-citation.md 规范标「」）——ASIC 是否在 2027 年底前显著撼动 NVDA 在 AI 加速器市场的 ~85% 份额？
...
**代表 2**：多数 sell-side（Bank of America / Morgan Stanley 2024-2026 系列研报）——TPU 卖给 Anthropic 主要因为 Google 既是供应商又是大股东，缺乏「free market」验证；AMD MI350 / MI355X 已发布但只有 Oracle 一个大客户公开部署 27K 节点，AMD 总份额仍 < 10%。

**代表 3**：NVDA 数据中心市占率 2025-2026 仍稳在 ~85%+（业内多家研究机构估算，TrendForce / Counterpoint / Bernstein 口径接近一致；第 7 章与第 29 章已交叉验证）。这是最直接的反驳——如果 ASIC 真在撼动 NVDA，市占率不会稳。
...
注：以上数据除 NVDA 财报、Google Anthropic 1M 公告、AWS Project Rainier 公告、AMD-OpenAI 大单等关键节点有一手来源外，其余多为业内估算（第 7 章已逐项标注「」），可证伪条件以「公开公告」为信号。

博通（AVGO）在上表中未单列出货行——其角色是 ASIC 设计 + 代工对接（fabless ASIC design house），不直接出货「自家品牌芯片」。博通 FY25 Q4 AI 半导体营收 \$6.5B，FY25 全年 AI 营收 \$20B（即平均约 \$5B/季；FY25 Q1 \$4.1B 为起点，Q4 \$6.5B 为终点），主要承担 Google TPU 与 Meta MTIA 的 ASIC 芯片设计 + 台积电代工对接——所以 Google TPU 与 Meta MTIA 的「出货」实际上是博通 + 台积电协作完成，博通的财务贡献以 ASIC 设计费 + 代工管理费形式记入营收。
...
**本书在这个议题上的位置与市场叙事相反**——本书的位置是「推理算力主导论 2027 之后才成立」，而非市场叙事里「推理算力即将主导」。理由：后训练在 2026-2027 期间会快速放量，推高训练侧权重；2027 之后 reasoning 模型普及 + 企业渗透率到位，推理才真正起量。
...
**触发器 C 持续 2 年即证伪本书「推理主导要到 2027 之后」这个立场**——本书需修正「推理主导 2027 之后」论点到「后训练在 2030 后才成型」。
...
**代表 2**：LBNL（Lawrence Berkeley National Lab）2024 报告——美国数据中心电力到 2028 年占总电力 ~12%（高端估算 580 TWh 对应口径；来源：本书第 27 章已引用，原文：[LBNL 2024 United States Data Center Energy Usage Report](https://eta.lbl.gov/publications/2024-lbnl-data-center-energy-usage-report)）。这个比例从总量上看不至于不可承载——是结构性挑战不是物理崩溃。
...
NVDA 当前（2026-06-25）Forward P/E ~22.32、EV/EBITDA ~24.22、P/S ~18.89、市值 \$4.74T（2026-05-14 盘中 ATH 约 \$5.7T，本书 data_cutoff 2026-05 时点市值约 \$5.15T）。注意 EV/EBITDA 从 2026-05 的 ~30.87 回落到 ~24.22，主要不是股价跌，而是 FY27 Q1 单季 EBITDA 大幅放量把分母抬高——估值倍数被盈利增长摊薄。议题：在 base / bull / bear 三套假设下，NVDA 当前估值落在哪个区间——已透支、合理、低估？
...
**代表 4**：思科（Cisco） 1999-2000 历史对照——思科在 1999-2000 年 forward P/E 峰值 ~130x，2000 年 3 月后股价跌 80%+，2024 年才回到 2000 年高点。NVDA 当前 Forward P/E 21 显著低于思科顶点；EV/EBITDA 的历史对比因思科 1999-2000 EV/EBITDA 缺一手公开锚（Damodaran 数据库未给出该年度 EV/EBITDA 精确值），本书不做点对点对比。

### 数据说了什么，以及分情况的判断

NVDA 估值与历史对照：

| 指标 | NVDA 2026-06-25 | NVDA 5 年均值 | 思科顶点 (1999-2000) | Lucent 顶点 (1999) |
|---|---|---|---|---|
| Forward P/E | 22.32 | 30-40 区间 | 130x（峰值） | 60+ |
| EV/EBITDA | 24.22 | 18-22 区间 | 30+ | 30+ |
| P/S | 18.89 | 15-25 | 15+ | 8+ |
| 营收增速 | +85%（FY27 Q1）| — | +50%+ | +20%+ |
| 毛利率 | 74.9%（FY27 Q1）| 60-65% | 50-55% | 45-50% |
| 市值 | \$4.74T（ATH \$5.7T，2026-05）| — | 顶点 \$555B | 顶点 \$258B |

NVDA 客户集中度反身性数据：

- NVDA 数据中心分部营收 **FY26 全年 \$193.7B**（NVDA FY26 10-K，2026-02-25 披露；本书第 12 章已详细引用）；
- FY26 年报口径：前 2 客户合计 36%（Customer A 22%、Customer B 14%；NVDA FY26 10-K）；Q2 FY26 季报口径：前 2 客户合计 39%（Customer A 23%、Customer B 16%，来源：CNBC 2025-08-28 报道 NVDA Q2 FY26 10-Q）；前 4 客户约 61%；Top 6 业内估算约 85%（本书第 18 章口径）；
...
**这个议题触及本书最核心的一条反共识判断**——本书的核心反共识不是「NVDA 必跌」也不是「NVDA 必涨」，而是「**客户集中度是 NVDA 估值反身性的核心**」。NVDA FY26 年报口径前 2 客户合计 36%（最大单一 22%）、Q2 FY26 季报口径前 2 客户 39%、前 4 约 61%——任一客户做出战略调整（如 MSFT 加速自建 Maia ASIC 部署、META 加速 MTIA、AMZN 加速 Trainium）都会触发 NVDA 估值反身性 repricing。这是 NVDA 估值最容易被市场低估的 risk vector。

不喊价格目标、不喊涨跌——本章只给中性 / 乐观 / 悲观三套区间，由读者根据自己的假设取舍。

读者如需自行测算合理区间，可用第 30 章 §30.3 设备商 P/E+DCF 模板里的反身性分析框架 + 本议题三情景假设组合，得到基于自身假设的估值结论。

### 什么信号出现，就算本书判断错了

本书「NVDA 当前已 fully priced 到 base 情景上沿」表态证伪条件：

**触发器 A（Bull 兑现侧）**：NVDA 2028 年数据中心营收 > \$400B（即从 NVDA FY26 全年数据中心分部营收 \$193.7B（NVDA FY26 10-K，2026-02-25 披露；本书第 12 章已详细引用）翻倍以上） + 毛利率维持 70%+。监测来源：NVDA 季度财报。如成立，本书的「fully priced」表态错误，NVDA 仍在低估区间。
...
**触发器 D（反身性触发）**：Mag7 任一家在 2027 年底前公开披露 ASIC 部署占算力 50%+，或 MSFT / META / AMZN 三家中任一家公开调低对 NVDA 采购合同 20%+。监测来源：超大规模云厂季度财报会 + 公司公告。如果成立，说明客户集中度带来的反身性风险已经兑现——本书「股价已把中性情景计满」的判断需要向悲观一侧修正。
...
**代表 1**：投资 CoreWeave 的英伟达、Magnetar、Coatue——合同储备 \$55.6B（2025 Q3；2026 Q1 已进一步跳到 \$99.4B）是 5 年合同未来收入锁定，乘 \$4-5 EV/Sales 给出 \$120-150B 估值合理。
...
- CoreWeave 截至 2026-06-25 市值约 \$53.9B（股价 \$98.76，2026-06-22 纳入 Nasdaq-100），落在本书 Bull 情景（\$50-70B）下沿——市场给的是接近「GPU 寿命 6 年 + 利用率 95%」的乐观假设定价。本书 data_cutoff（2026-05）时点曾给 \$35-50B 区间估算（理由：CoreWeave 自由流通股占比低、做空盘与 OpenAI 锁仓共存导致单点市值波动剧烈，见 data/31-disputes-defense/sources.md 数据缺口说明）；随股价上行，当前公开市值已升到区间上沿之上，但波动性结论不变（52 周区间 \$63.80-173.35）；
...
**反共识洞察**：本书在第 16 章 §7.4 已提出——GPU 云的稳态盈利区间宽度 35-40 pp（Bear -25% 到 Bull +15% 自由现金流 margin），是 SaaS 行业典型公司宽度的 4-5 倍。这意味着 GPU 云的估值倍数应该基于「Base 给定 + Bear / Bull 做敏感分析」，而不是单点估值。本章把这个论点正式化为可证伪条件。
...
类似条件可推广到 Nebius / Crusoe / Lambda / Together——这里不展开（详见第 16 章）。
...
**代表 1**：美国国会两党 + CSIS 系列分析。论点：禁运让中国 AI 训练大幅延后，华为 Ascend 性能 + 良率 + HBM 都跟不上前沿。
...
**代表 1**：Dylan Patel（SemiAnalysis）"Huawei Ascend Production Ramp" 2025-09-08。关键数据：华为 + 中芯国际 2025 出货 805K Ascend（其中 653K 是 910C）—— 量已经起来；2026 计划 600K+ 910C；HBM 国产化推进中。

**代表 2**：Bernstein 系列研究。核心：910C + 910B 2025 总产能 1.05M 颗 logic 裸片；中芯国际 7nm 良率 ~40% 稳步提升；中国超算榜单上 Ascend 集群已占多席。

**代表 3**：SemiAnalysis 2025-09 同源——「三星 alone has directly provided 11.4 million stacks of HBM to China, with a staggering 7 million units exported in a single month following the December 2024 control announcement」（SemiAnalysis 2025-09-08 原文）。三星出口路径让中国 HBM 存量比预期高。
...
| 华为 Ascend 出货 | ~507K（910B 为主） | ~805K（910C 占 653K） | 1M+（计划） |
| 中芯国际 7nm 良率 | ~30% | ~40% | 推算 45-50% |
...
- **场景 A（禁运短期有效 + 长期国产化吃掉部分）**：到 2028 年底，NVDA 中国营收 < \$5B/年（持续下行），华为 Ascend 出货 > 1.5M/年（持续上行）—— 这是本书的基线判断。
- **场景 B（禁运无效）**：NVDA 中国营收回升 \$10B+/年（H200 大规模放开），华为 Ascend 出货 < 800K/年（国产化失败）—— 概率低。
- **场景 C（禁运过度有效）**：NVDA 中国营收 \$0 + 华为 Ascend 出货 > 2M/年 + 中国 AI 训练前沿能力追上美国 - 12 个月内——概率极低，要求 HBM 国产化和先进封装同时突破。
...
边界——本议题最大数据缺口是华为真实出货 + 中芯国际真实良率（均为业内估算，无一手）。本书的可证伪条件刻意以 NVDA 公开口径 + 中国 lab 公开模型披露为锚——避免单独依赖。
...
| 11. H20 出口管制 | 四场景式（A 短期有效长期国产 / B 无效 / C 过度有效 / D 递减） | Y1 场景 B: NVDA 中国营收回升 \$10B+/年 + 华为 < 800K/年（2028 底前）；Y2 场景 C: 中国 lab 公开 frontier-class 模型用 100% 国产芯片（2027 底前）；Y3 场景 D: BIS 2027-2028 任一年新增管制 > 3 次且被 reroute 化解 |
...
| 5. 训推比例 | 推理主导 2027 之后 | A: 头部 lab 推训 > 3:1 持续 2Q（2028 底前）；B: 单次训练 > 4GW + 训占年度 > 60%；C: 2027 底前后训练未超 pre 30% | 任一持续 2Q 证伪对应子项 |
| 6. 杰文斯悖论 | 18-36 月内悖论主导，中间有一次休整 | A: NVDA 调下数据中心增速 < +20%；B: 企业 AI 增速降至 +50%- 持续 4Q；C: NVDA 2028 前无任一季度 < +20% | A+B 同时 4Q 证伪悖论；C 单独证伪反共识中场休息 |
...
- 产能：台积电财报电话会 + TrendForce / SemiAnalysis 月度
...
媒体专栏的特点是「立场鲜明 + 标题党 + 缺乏数据」。本书 12 议题逐一展开五段式，每个议题都挂着两派的一手出处和关键数据，立场是基于数据的整合判断、而非情绪表达。

社交媒体行情号的特点是「短期博弈 + 涨跌喊话」。本书拒绝喊价格目标、拒绝涨跌判断，给的是中性 / 乐观 / 悲观三套区间，外加证伪条件。
...
| 9 | NVDA 估值 | 条件式 | base / bull / bear 三套；当前股价已把中性情景的上沿完全计入 |
| 10 | 一级 GPU 云估值 | 条件式 | 估值脆弱；四支撑同时成立才合理 |
| 11 | H20 出口管制 | 条件式 | 场景 A 基线 + 部分场景 D；中国前沿训练落后 12-24 个月 |
| 12 | 东数西算 | 条件式 | 训练真用 + 推理物理约束；西部能源 + IDC 真实赢家 |

这张表加上 12 个议题各自的证伪条件，就是一份可以逐季核对的清单。未来两三年里哪一条兑现了、哪一条被推翻了，读者自己就能查。

---

> **免责声明**
>
> 本章涉及英伟达、Microsoft、Meta、Alphabet、Amazon、Oracle、AMD、博通、CoreWeave、Nebius、Crusoe、Lambda、Together、Vistra、Constellation、Oklo、Kairos Power、NuScale、X-energy、华为、中芯国际、字节跳动、阿里巴巴、腾讯、华为云、Anthropic、OpenAI、xAI 等具体公司的财务分析、产业判断与可证伪条件设定，仅为作者基于公开信息（SEC 财报、公司 IR 公告、卖方研报、媒体报道、行业研究机构数据、政府文件）做出的产业研究与方法论论证，**不构成任何投资建议**，也不构成对任何公司股价走向的预测或建议读者买卖任何证券、衍生品或参与任何融资融券交易。市场有风险，投资决策应基于读者自身的独立判断和专业咨询。
>
> 本章对 David Cahn（Sequoia Capital）、Michael Burry（Scion Asset Management）、Jim Covello（Goldman Sachs）、Dylan Patel（SemiAnalysis）、Mark Zuckerberg（Meta）、Jensen Huang（英伟达）、Cathie Wood（ARK Invest）、Brad Gerstner（Altimeter）、Tony Grayson 等公开发表的产业观点与争论做了完整复述与分析，是学术性的方法论论证审视，不代表作者对上述各方观点的支持或反对，也不代表作者对相关公司财务政策、折旧合规性、估值合理性的法律或会计判断。本章中「中性 / 乐观 / 悲观三套测算」「四场景」「条件式表态阈值」是用作分析的尺子，不是估值结论或交易信号；具体公司估值结论由读者结合第 30 章的估值工具箱 + 自身风险偏好独立形成。
>
> 本章的「可证伪条件」是方法论承诺而非投资策略——读者不应将「触发器 A 出现」理解为「建仓 / 平仓信号」，也不应将本书的明确表态或条件式表态作为操作依据。可证伪条件的设计意图是建立产业判断的可追踪、可修正机制，与具体证券的买卖决策无任何对应关系。
>
> 本章使用的财务数据、市场份额、估值倍数、产能数据、市占率、出货量、政策数据、市场叙事基线截至 2026-05，其中 NVDA / CoreWeave 的股价、市值、估值倍数与合同储备已刷新至 2026-06-25（正文以日期标注）；公司基本面、市场环境、利率水平、AI 产业周期、地缘政治格局、监管政策可能在阅读时已发生显著变化，部分数据点的更新可能会改变本章可证伪触发器的具体阈值。本章中提到的公司股票、估值倍数、目标价区间、市占率、市值等信息均为分析素材，作者不对其准确性、完整性或时效性作任何承诺。本章涉及多处「业内估算」「区间估计」「无法验证」标注（议题 4 ASIC 出货量、议题 5 训推口径、议题 10 CoreWeave 业内市值估算、议题 11 华为 Ascend 真实出货 + 中芯国际真实良率、议题 12 西部数据中心利用率等）——是因为相关一手数据非公开，作者明确标注估算区间而非点估计，避免读者误读为精确数据。
>
> 本章只做产业分析，不采用传统投资分析那套「持仓披露 + 投资建议」的模式——作者的角色是产业研究者与方法论论证者，不是投资顾问、不是基金管理人、不是经纪商，与本章涉及的任何公司无商业利益关系、咨询关系或代理关系。如读者发现本章存在事实错误、数据出处错误、可证伪条件设计瑕疵或论证漏洞，欢迎在 inferloop.dev 反馈勘误。
