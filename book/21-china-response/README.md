...
**第二，晶圆代工这一件套是国产替代的硬上限**。中芯国际的 N+1 / N+2 节点没有 EUV 光刻机（2020-Q3 BIS 禁止阿斯麦向中芯国际出口 EUV，至今仍生效），靠 DUV（193nm 浸没式）多重曝光把图案分多次曝光合成 7nm 等效电路。这条工艺路径在物理上可行，但单裸片良率显著低于台积电同节点（业内估算中芯国际 N+2 良率 30-50%，中值 40%；台积电 N5 / N4 良率 90%+），且单晶圆 ASP 业内估算比台积电低 30-40% 但折算合格裸片单价反而高出 20-50%。需求侧并不缺：中芯国际 2026 Q1（2026-05 披露）单季营收 \$2.5B、产能利用率 93.1%、毛利率 20.1%，Q2 指引营收环比 +14-16%——产能被国产替代订单填满，瓶颈在良率与产能扩张速度，不在订单。代工差距是华为 Ascend 出货量的天花板，下面 21.5 节单独展开。
...
Ascend 910C 在 2025 年的真实出货量是议题 11 / 12 论证里争议最大的数字。华为非上市，不披露单卡出货量；中芯国际不分客户披露代工产能；CXMT 不公开 HBM 月产能。所以这个数字只能用产业链反推。
...
议题 11 论证的另一半是线 B——除了国产替代，互联网大厂仍在大规模采购英伟达在出口管制下被允许出口的 mid-end 卡。
...
把这件事的产业含义压成一句话——**中国 AI 算力市场与海外超大规模云厂市场在 2025-2026 年已形成事实上的隔离市场，量级差 ~10x，结构差异显著**。议题 11 / 12 论证的整体场景是在这个隔离市场内部考察国产替代的进度。

## 21.9 线 B 的另一面：东数西算与训推分裂（议题 12 主论证）
...
读这张表的方式：训练侧的西迁不是政策强推下的勉强搬迁，是客户基于电价 + 单一大集群规模优势的市场化选择 + 政策导向的混合结果。阿里乌兰察布、字节宁夏中卫这两个最早期的训练集群在政策启动（2022-02）之前就已经在规划，东数西算政策给了这些项目土地审批 + 网络专线 + 电力配额的优先支持。议题 12 在训练侧的论证是——**西迁逻辑成立**。
...
这条物理事实让推理工作负载的东数西算在技术上不成立——推理必须靠近用户。东数西算政策的有效边界因此被限定在训练侧。这是议题 12 论证的核心微观证据。
...
## 21.10 议题 11 论证：H20 出口管制效果（短期 / 中期 / 长期）

把前面 21.2 至 21.9 节的所有事实组装成议题 11 的完整论证矩阵。
...
- 华为 Ascend 910C 2025 全年出货采用两套独立口径：SemiAnalysis 2025-09 *华为 Ascend Production Ramp* 产线预测全 Ascend 805K 颗 / 其中 910C 单型号 653K 颗 / HBM 约束悲观情景 250-300K 颗；IDC 2026-04 *中国 AI 加速卡市场报告* 事后实际全 Ascend 812K 颗（与 SemiAnalysis 805K 预测落在同一量级）；本书议题 11 论证用的受 CXMT HBM 约束的 910C 单型号口径取 25-30 万颗悲观区间
...
## 21.11 议题 12 论证：东数西算训推分裂

议题 12 在 21.9 节已经给出完整微观证据。这一节把论证压缩成五段式格式（与第 31 章议题论证五段式一致）。
