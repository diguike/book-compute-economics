...
第 10 章与第 27 章的边界：第 10 章处理作为算力产业链一环的数据中心电力，第 27 章处理作为宏观经济外溢的算力 vs 电力市场。同一句 PJM 容量市场清算价 +800%，在第 10 章是数据中心选址成本输入，在第 27 章是普通居民电费账单上涨输入。两章的视角差是本章独立成章的理由。

本章承担三件硬任务：(1) **议题 7（电力是不是真瓶颈）的主答辩**——核心 IDC 集群 2026-2028 是真瓶颈，全国 / 全球层面有冗余。第 10 章给物理基础、第 14 章给次生硬约束位，本章把为什么瓶颈是局部的、政治后果是全局的讲透；(2) **议题 8（SMR 2030 前能否对算力供电有意义）的主答辩**——2030 前几乎无意义。Big Tech 的 SMR PPA（Google-Kairos / Amazon-X-energy / Microsoft-TMI 重启）是 2032+ 的故事，对 2026-2029 这一轮资本支出周期的算力供电杯水车薪；(3) **段落级 disclaimer 段**——27.10 给出 [GE Vernova](https://www.gevernova.com/) / [Vistra](https://www.vistracorp.com/) / [Constellation Energy](https://www.constellationenergy.com/) / Eaton 四家 AI 电力链卖铲人的受益规模量化，严格 commentary-only。

本章的差异化亮点在 27.6政治回压。卖方研报与产业号几乎不写这一节：弗吉尼亚 / 德州 / 俄亥俄 / 乔治亚四州的居民电费上涨曲线、立法反应、Dominion Energy / Duke Energy 的 cost allocation 之争。算力资本支出不是单纯产业链问题，它正在变成普通用户的钱包问题——这是 2026 年之后会持续放大的政治变量。
...
须严格区分 SMR 技术示范与 SMR 商业发电。Hermes 是技术示范堆（不并网商业供电），第一座并网的 Kairos 商业 SMR 是计划 2030 年的项目。Google 的 500 MW 承诺分布在 2030-2035 年的多座 SMR 上。从 2030 年第一座 50 MW 商业并网到 500 MW 全部到位，Google 的 SMR 电力供给主要在 2030 年代中后期兑现——对 2026-2029 这一轮 AI 算力资本支出周期的电力供应没有任何帮助。这是议题 8 答辩的核心数据点。
...
议题 7 的反共识细节：议题 7 在公开市场已是共识——所有人都同意电力是 AI 算力的瓶颈。本章的反共识不在是不是瓶颈，而在**瓶颈带来的地理结构性后果**。卖方研报与产业号通常把电力瓶颈作为超大规模云厂资本支出上限的判断输入，但很少深入到电力瓶颈会把数据中心地理图谱重画这一层。

本章的判断是：电力瓶颈会让算力地理在 2027-2030 年发生结构性迁移——从北弗 / 硅谷 / 凤凰城为代表的传统数据中心走廊，迁移到爱荷华 / 内布拉斯加 / 俄勒冈东部 / 怀俄明 / 北达科他为代表的低电价 + 富裕一次能源二线集群，以及中东 / 北欧 / 东南亚为代表的 sovereign AI 集群（与第 23 章联动）。这是算力资本支出周期最被低估的长期外溢之一。
...
**与第 10 章的边界**。第 10 章「数据中心与电力」给的是数据中心选址视角下的电力——PJM 是什么、北弗 Loudoun 排队 4 年是怎么回事、IDC REIT 的 FFO 怎么读、Crusoe 自建 vs Equinix 托管的 TCO 对照。本章给宏观经济影响视角下的电力——容量市场清算价跳变到居民电费、长期 PPA 锁定 baseload 对非超大规模云厂用户的挤压、四州政治回压、电力链受益公司的业务结构。同一个 PJM 容量价格在两章扮演不同角色：在第 10 章是数据中心选址成本输入，在第 27 章是普通居民电费上涨输入。

**与第 14 章的边界**。第 14 章「缓解之后」把电力作为芯片侧瓶颈缓解后的次生硬约束，强调 2027 之后的预警意义。本章处理 2024-2026 已发生的事实层面与 2026-2028 持续发酵的政治层面，不抢第 14 章的预警位。

**与第 23 章 / 第 30 章 / 第 31 章 / 第 32 章的链接**。第 23 章 sovereign AI 章承接本章 27.7 的算力地理再分布判断；第 30 章估值模板章给 4 家电力链公司的 EV/EBITDA 模型（本章只给业务结构与受益规模，不下估值结论）；第 31 章五段式答辩把本章议题 7 与议题 8 的主答辩作为输入；第 32 章把本章电力是真瓶颈但地理结构性迁移作为 2030 年情景预测输入。
...
电力市场的故事到本章为止讲完了从微观（变压器 + PJM）到中观（PPA 与受益公司）到宏观（政治回压与地理结构性迁移）的全链路。下一章第 28 章 「出口管制：算力的地缘政治屏障」接力——电力是物理瓶颈，出口管制是政治瓶颈，两者共同决定 2026-2030 算力供给的可分配空间。
