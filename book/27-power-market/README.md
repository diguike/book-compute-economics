...
**与第 10 章的边界**。第 10 章「数据中心与电力」给的是数据中心选址视角下的电力——PJM 是什么、北弗 Loudoun 排队 4 年是怎么回事、IDC REIT 的 FFO 怎么读、Crusoe 自建 vs Equinix 托管的 TCO 对照。这里给的是宏观经济影响视角下的电力——容量市场清算价跳变到居民电费、长期 PPA 锁定 baseload 对非超大规模云厂用户的挤压、四州政治回压、电力链受益公司的业务结构。同一个 PJM 容量价格在两章扮演不同角色：在第 10 章是数据中心选址成本输入，在本章是普通居民电费上涨输入。

**与第 14 章的边界**。第 14 章「缓解之后」把电力作为芯片侧瓶颈缓解后的次生硬约束，强调 2027 之后的预警意义。这里处理 2024-2026 已发生的事实层面与 2026-2028 持续发酵的政治层面，与第 14 章的预警位互补不重叠。
