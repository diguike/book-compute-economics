...
> 同一笔生意，三种折旧期假设下 Adj. EBITDA 利润率从 61% 跌到 15%——46 pp 的差距全部来自会计政策的可调旋钮。这是 Michael Burry 2025-11 公开攻击超大规模云厂折旧政策的核心依据（详见 §5）。
...
从 \$120B 到 \$60B 的估值半价区间，反身性触发器只需要 Microsoft 的一个内部决策——CoreWeave 估值的脆弱性远高于其合同储备数字暗示的稳定性，根源就在这里。本书反共识 #5「客户集中度是估值反身性核心」的机制埋在这里，结论留给第 30 章。
...
> 业内估算综合 Morgan Stanley / Mizuho 2025 GPU 云覆盖研报 + 各家公开营收口径。[Vultr](https://www.vultr.com/) 等长尾玩家合计约 17%。CoreWeave 单家占独立 GPU 云市场过半——这是议题 10 的微观底盘。
