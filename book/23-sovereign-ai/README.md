...
如果说 IndiaAI Mission 是政府催化剂，那么真正的算力主力来自印度私营巨头。[Reliance](https://www.ril.com/) Jio 在 2024 年宣布与 NVIDIA 合作建设印度 AI 算力基础设施，规划规模在 GW 量级。Reliance 旗下的 Jio AI Cloud 服务于 2024 年 8 月在年度股东大会上由 Mukesh Ambani 公开宣布。
...
本章把视角从供给侧（产业链）与需求侧（应用）切换到资本侧（谁出钱）。下一章（第 24 章）会把视角再切换一次——从经济视角看待算力本身——讨论算力是否是通用目的技术（GPT, General Purpose Technology）。

主权 AI 资本的兴起为这一问题提供了一个数据点。如果算力只是一个垂直行业的工具，主权基金不会大规模直接投入——它们会通过 LP 形式间接参与，把执行交给市场玩家。但 2024-2025 间主权基金的直接下场显示，国家级别玩家开始把算力视为国家产能（national 产能）而非市场商品（market commodity）。这种判断本身就接近 GPT 的定义——19 世纪铁路、20 世纪电力、20 世纪末互联网，都是被国家级别玩家视为产能的技术。
