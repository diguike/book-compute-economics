...
第七节把本章的判断收紧成两条可证伪的对立预测——本书在 Brynjolfsson J 曲线偏乐观派与 Acemoglu 任务导向偏悲观派之间倾向哪一边、需要哪些 2026-2030 年的实证落地才能站住。这一节是全书宏观叙事的关键支点之一：第 26 章将从这里出发讨论 AI 对人力资本与就业的影响，第 29 章（周期定位）将拿 TFP 红利显化时滞作为周期判断的输入之一，第 32 章（五年情景）将把 J 曲线 vs Acemoglu 的双方观点作为情景分叉的核心变量。

对工程师读者，本章把 AI 提高生产力这个日常感受翻译成 5 条可分别落地的渠道——某项工作中 AI 让你快了 30%，到底走的是哪一条渠道、宏观加总后该是多少。对金融读者，本章给 AI 投资回报率提供宏观对照——为什么不能用 2025 年 BLS TFP 数据否定超大规模云厂的 \$400B 资本支出，也为什么不能用超大规模云厂的资本支出倒推宏观 TFP 必然大涨。
...
把本章的 5 渠道分解与 J 曲线判断收尾，最后一段过渡到第 26 章。
...
把 AI 提升整体 TFP 翻译成 AI 对不同劳动力群体的差异化影响，是第 26 章的核心任务。第 26 章将用 Acemoglu-Restrepo 任务导向框架的 displacement effect vs reinstatement effect 双引擎，加 Goldin-Katz 技能溢价框架的供需赛跑，把哪些岗位被替代 / 哪些岗位被增强 / 哪些岗位是新创造这三个问题在 7 个职业样本上具体化。

需要继续追问的是：本章给出的 J 曲线中位 0.265pp / 年的 TFP 加速，落在哪个劳动力群体身上、以什么形式落地。Brynjolfsson-Li-Raymond 2023 客服实验里低技能员工 +34%的发现已经透露了方向——AI 倾向于把行业内技能溢价压缩。但技能溢价压缩是不是社会整体的不平等下降——这取决于行业之间的工资分布如何变动。Acemoglu (2024) 的判断是不平等会上升而非下降；Brynjolfsson 等的判断是低技能群体获益更大。这是第 26 章要回答的核心问题。

数据上需要的下一步：从本章的 5 渠道分解切到第 26 章的7 个职业样本工资曲线 + 就业人数曲线 + 岗位 posting 曲线。本章给出的 J 曲线时滞框架，将成为第 26 章判断短期焦虑舆论 vs 中长期真实数据的时间尺度参照——10-15 年时滞意味着短期 AI 对就业的影响很可能被替代效应主导，长期才显化重置效应。
