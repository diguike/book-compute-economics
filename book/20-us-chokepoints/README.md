...
三类工具对阿斯麦 / NVDA / SK 海力士等公司财务模型的具体影响、以及产业链供给侧价值重新分配，留给后面的财务模型章与全球格局章分别展开。

下一章接下来要回答的问题：被管制方在过去 8 年的应对路径是什么？华为 Ascend、CXMT HBM、中芯国际 N+2 这些反向证据在产业经济学上能撑到什么节点？中国在哪些环节实现了真正的替代、在哪些环节仍然有不可逾越的硬上限？这是 chokepoint 经济学的另一面——只有把双方都看清楚，才能给出中心-半边缘-边缘叙事的完整图景。
