...
后续章节会把本章的判断逐项展开：第 25 章正面回答 TFP 渠道与 J 曲线，第 26 章主答辩人力资本与就业，第 29 章主答辩周期定位（含「不是 telecom 2.0」反共识），第 32 章主答辩五年情景。本章只给坐标系。
...
第 26 章将正面回答人力资本与就业渠道——算力对就业总量、收入分配、技能 premium 的影响，类似 Acemoglu-Restrepo (2020) 任务替代框架的算力版重估。

第 27 章-28 将正面回答通胀与货币政策渠道——算力资本支出拉动的固定资产投资周期对宏观需求的影响、对央行政策的影响。

第 29 章将正面回答周期定位——算力扩散的当前位置、是否处于 telecom 1999-2000 类似的泡沫期、与历史泡沫的同与不同。本章 24.4 节的2026 ≈ 电力 1908 / ICT 1990位置定位是第 29 章的输入。

第 30 章将正面回答资本市场表现——算力相关板块的市值动量、估值倍数、与历史 GPT 资本市场反应的横向比对。

第 31 章-32 将正面回答政策与五年情景——算力 GPT vs 大宗商品类比的政策含义在第 31 章展开。
