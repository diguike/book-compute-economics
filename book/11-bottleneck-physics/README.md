...
价格紧缺是表层现象，物理紧缺与时序紧缺才是机制。**只论物理紧缺与时序紧缺**——前者解释为什么 CoWoS 与 HBM 在 2024-2026 这一轮周期里成为产业链的硬性约束（§11.2-11.5），后者解释为什么这种紧缺有时间维度（§11.6）。价格紧缺涉及 NVDA / SK 海力士议价权与会计学，留给 NVDA 五税 + GPU 云解剖的两章主答辩。
...
本章给出的是物理学维度——四因素叠加证明物理紧缺真实存在。下一章把这条物理曲线翻译成时间维度——**2027 拐点 + 三个预警信号 + Akerlof 二手市场反向应用**。三个可证伪的早期信号（H100 现货价跌破 \$2.5/hr、Hopper 二手挂牌价跌破新机 60%、三星 HBM3e 12-Hi 重获 NVDA 主流分配）与本章 §11.8 的双阈值证伪条件共同构成本书对议题 3「算力紧缺真伪」的完整答辩体系。
...
下一章把物理学翻译成时间——2027 拐点 + 三个预警信号 + Akerlof 二手市场反向应用。它会在本章物理基础上向前推一步——给出紧缺有窗口的反共识立场 + 三个可量化监测的早期预警信号 + 一组立此存照的可证伪承诺。两章合起来，是本书对议题 3「算力紧缺真伪」的完整产业研究答辩——本章给基线，下一章给拐点。
