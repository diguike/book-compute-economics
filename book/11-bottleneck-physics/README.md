---
title: "第 11 章 双瓶颈的物理学：CoWoS 与 HBM 为什么是真紧缺"
...
# 第 11 章 双瓶颈的物理学：CoWoS 与 HBM 为什么是真紧缺

## 本章概览

「算力是真紧缺还是 [NVIDIA](https://www.nvidia.com/) 营销叙事？」这是研究 SUMMARY 列出的 12 个争议议题里第 3 号议题，也是 2024-2026 二级市场对 AI 算力行业最分裂的一个问题。
...
本章给这个问题一个供给侧的物理答案。第二部第 5 章、第 6 章已经给出 CoWoS 与 HBM 的**横截面**——当下产能、玩家结构、利润分配（详见第 5 章 §5.3-5.5 与第 6 章 §1-5）。本章给出**机制与时序**——为什么这种紧缺真实存在、为什么短期内不可能被一两家厂加点资本支出就消除掉、四组数字怎么叠加成 HBM 单 stack 价格从 2022 年的 \$80 量级涨到 2025 年合约的 \$300+ 这个产业事实。
...
- **设备 + 厂房扩产周期**——ASML EUV 光刻机在手订单交货 18-24 个月、[台积电](https://www.tsmc.com/) 嘉义 AP6/AP7 新厂从立项到通线 1.5-2 年、HBM 新 fab 从设备到货到首片良品 24-30 个月，每一档都是物理时间。
- **客户认证准入墙**——[Samsung](https://www.samsung.com/semiconductor/) HBM3e 12-Hi 通过 NVDA 认证花了 18 个月、[Micron](https://www.micron.com/) 借 HBM3e 8h/12h 弯道进入 NVDA 主供应链、台积电 CoWoS 在 NVDA / AMD / Broadcom 之间分配额度的非线性博弈。
...
4. 第三因素：设备与厂房扩产周期——ASML 交期 + 台积电新厂 + HBM fab 设备的物理钟
5. 第四因素：客户认证墙——Samsung 18 个月 / Micron 弯道 / CoWoS 客户分配博弈
...
**第三层，时序紧缺**——某个产品在特定时间点（如 NVDA Blackwell 量产爬坡期）出现的供需错配，本质是产能曲线与需求曲线的相位差。时序紧缺的特征是有明确的开始与结束时点。HBM3e 12-Hi 在 2024-Q3 至 2026-Q2 之间的 NVDA 认证 + Micron + SK Hynix 两家供格局就是时序紧缺——Samsung 通过认证后（2025-09 通过；来源：TrendForce 2025-09-22 + KED Global 2025-09-19）格局开始松动，2027 年 HBM4 三家同步爬坡后窗口结束（详见第 12 章 §12.3）。
...
价格紧缺是表层现象，物理紧缺与时序紧缺才是机制。**只论物理紧缺与时序紧缺**——前者解释为什么 CoWoS 与 HBM 在 2024-2026 这一轮周期里成为产业链的硬性约束（§11.2-11.5），后者解释为什么这种紧缺有时间维度（§11.6）。把价格紧缺单独剥离出去的原因是——它涉及 NVDA / SK Hynix 议价权与会计学，归属于第 7 章（NVDA 五税）与第 16 章（GPU 云解剖）。
...
|---|---|---|---|---:|
| SK Hynix | 2023-Q4 NVDA H100 / H200 主供 | 2024-Q2 12-Hi 通过 NVDA 认证，Q3 量产 | 2026-02 启动量产，Vera Rubin 首发 | 170K（业内估算）|
| Micron | 2024-02 NVDA H200 量产订单 | 2024-09 12-Hi 通过 NVDA 认证 | 2026-03 在 GTC 官宣进入 high-volume production for Vera Rubin | 80-90K（业内估算）|
| Samsung | 2024-03 Jensen Approved 但反复失败 | 2025-09 终于通过 NVDA 12-Hi 认证 | 2026-02 启动出货，2026-06 起 full-scale supply | 250K（公司指引）|

> 来源：SK Hynix HBM3e/HBM4 量产时点综合 SK Hynix 2025-09 mass production ready 公告（TrendForce 2025-09-12 转引）、Digitimes 2025-12-26 HBM4 加速量产报道、SK Hynix 与台积电北美技术论坛 2025-04 公告；Micron HBM4 时点综合 Micron 投资者关系新闻稿 GlobeNewswire 2026-03-16、StorageNewsletter 2026-03-17、Tom's Hardware 2026-03、Futurum 综合 Q1 FY2026 财报电话会 2025-12；Samsung HBM4 量产综合 TrendForce 2026-01-26 报道、Digitimes 2025-12-26；Samsung 2026 HBM 总产能 250K 晶圆/月指引来自 TrendForce 2025-12-30。三家 HBM 月产能与 NVDA 采购占比为业内估算，三家与 NVDA 均不公开披露分品类数据，估算区间 ±20%。

这张表读起来要注意两件事。

**第一件，三家量产时点和形成有效供给是两回事**。SK Hynix 2026-02 启动量产，但首批月度 HBM4 出货量业内估算只有 50-100K stack 区间，距离稳态产能差远了——量产到稳态需要 6-9 个月的良率爬坡（业内估算综合 SK Hynix 历年量产记录 + SemiAnalysis 转引）。Samsung 的 full-scale supply 推迟到 2026-06 起，意味着 2026 上半年三家齐头并进实际上仍是 SK Hynix + Micron 两家供 + Samsung 少量补充的格局。

**第二件，HBM 与 CoWoS 的瓶颈是耦合的**。HBM3e / HBM3 时代，HBM stack 在 DRAM 厂内自产自销——base 裸片由 DRAM 厂自己用 DRAM 工艺做，不依赖外部 foundry。HBM4 时代 base 裸片改用 logic 工艺，由台积电用 N5（5nm）/ N3（3nm）代工——SK Hynix 在 2025-04 台积电北美技术论坛公开宣布 HBM4 的 base 裸片由台积电用 logic 工艺代工。Micron 的 HBM4 也走台积电路线（业内估算节点 N5），Samsung 用自家 logic 工艺做 base 裸片。**这意味着 HBM4 之后，台积电的 N5 / N3 产能 + CoWoS 产能共同成为 HBM 的间接约束**——CoWoS 与 HBM 两个瓶颈在 HBM4 时代物理上合体。这是 §11.6 四因素叠加里 CoWoS 利用率 这个变量直接影响 HBM 价格曲线的根因。
...
进入 2026 上半年后缺口开始收窄——CoWoS 月产能爬到 60K+、HBM4 三家陆续量产、Samsung 在 HBM4 端通过认证（2026-01 SIP 测试通过）——这是第 12 章 §12.4 给出的2026-Q4 至 2027-Q2 是第一次结构性缓解窗口判断的供给侧基础。本章只论缺口的物理存在；缺口何时关闭的时序判断留给第 12 章。

### 一组反共识对照：NVDA 营销叙事的反向证据

议题 3 的多空对照里，空头的核心论据是紧缺是 Jensen 在法说会上反复重复的话术，配合卖方共识被放大成稀缺溢价。但 §11.2 给出的供给-需求季度对照表里有三组反向证据可以排除营销叙事的解释：

1. **HBM 厂同步赚到价格**：SK Hynix FY25 营业利润率 49%、Micron Q1 FY26 营业利润率 47%。如果紧缺只是 NVDA 营销，HBM 厂不会同步出现 DRAM 行业过去 30 年没见过的营业利润率。HBM 三家是独立的上市公司，它们的盈利结构是供需失衡的真实出清结果。
...
> 来源：单裸片良率假设为业内估算（综合 SK Hynix、Samsung、Micron 历年学术论文披露的 DRAM 裸片测试良率范围 + SemiAnalysis 转引；三家均不公开裸片与 stack 良率的精确数字）。整 stack 良率为理论计算，实际还要叠加 TSV 工艺良率、base 裸片良率、bonding 良率，业内估算综合良率比理论值再低 5-10 个百分点。

SK Hynix 之所以能在 HBM3e 12-Hi 上守住主导位（2025-Q2 市占 62%，来源：TrendForce 2025-Q2 数据），靠的是单裸片良率做到 99%+，把 stack 总良率推回 85% 这条线（业内估算）。**业内估算的路径是三件事叠加**：(1) 1a-1b nm 工艺成熟度领先 Samsung 与 Micron 半个代际；(2) MR-MUF（Mass Reflow-Molded Underfill，整片回流焊接 + 模塑下填充）封装工艺降低 stack 翘曲与热阻；(3) 单裸片出厂前 EDS（Electrical Die Sorting，电学晶粒分选）多轮筛选，把进入堆叠环节的裸片良率从行业水平 95-96% 推到 99%+。SK Hynix 用 10 年 HBM 经验把这三件事的工艺曲线压实了，这是 Samsung 重新做 redesign 也短期补不上的过程知识。

把这条良率曲线翻译成产能含义：HBM3e 12-Hi 量产初期良率 50-60%、稳态 80%（业内估算综合 SemiAnalysis + Bernstein）。从 50% 爬到 80% 通常需要 6-9 个月，这意味着即使三家厂同时在 2026-Q1 启动 HBM4 量产，要在 2026-Q4 同步进入稳态有效供给状态需要良率全部爬到 75-80%——这个节奏对良率最薄弱的 Samsung 是个挑战（Samsung HBM3e 12-Hi 直到 2025-09 才通过 NVDA 认证，工艺老化时间最短）。
...
把这条二阶传导写成公式：单裸片良率 = (1 - 缺陷密度)^裸片面积。HBM3e 24 Gb 裸片面积约 90 mm²，HBM4 32 Gb 裸片面积约 115 mm²，单裸片面积增加 28%。如果工艺缺陷密度不变（DRAM 工艺成熟阶段），单裸片良率会下降约 4-5%。SK Hynix 在 HBM3e → HBM4 切换中要做的事就是把 1a-1b nm 工艺缺陷密度同步降低，让单裸片良率维持在 97%+ 水平——这是 SK Hynix 守住 HBM4 主导位的工艺基础。
...
> 来源：CoWoS-L 工程挑战综合 3DInCites 2024-10-18 报道（NVIDIA Blackwell CoWoS-L 翘曲与 CTE 失配问题）、台积电在 IEDM / VLSI Symposium / Symposium on Advanced Packaging 历年论文披露、SemiAnalysis "Advanced Packaging Part 2" 2022。CoWoS-L 大面积 interposer 良率为业内估算，台积电给定性披露，量化数字仅有 SemiAnalysis 等估算，按业内估算标。
...
HBM4 这一代相比 HBM3e 多了一个工程不连续点——base 裸片（HBM stack 底部的 IO 与控制逻辑层）从 DRAM 工艺切换到 logic 工艺。HBM3 / HBM3e 的 base 裸片是用 DRAM 工艺（10nm 级，主要做 IO 缓冲与控制逻辑）做的；HBM4 base 裸片切换到台积电的 N5（5nm）/ N3（3nm）logic 工艺（SK Hynix 在 2025-04 台积电北美技术论坛公开宣布；来源：SK Hynix 新闻稿 2025-04-23）。
...
2. **base 裸片与 DRAM 裸片的 hybrid bonding 工艺**：HBM4 base 裸片用 logic 工艺做后，与上方 DRAM 裸片的接合精度要求更高——传统 micro-bump 间距 40 µm，HBM4 部分定制版本目标 hybrid bonding（间距 < 10 µm）。Samsung 已经在 HBM4E 后续路线上公开 hybrid bonding 20-layer 路线。Hybrid bonding 工艺良率在量产初期会再低 5-8 个百分点。
3. **三家厂工艺路径分化**：SK Hynix HBM4 base 裸片由台积电 N12 → N5 代工；Micron HBM4 base 裸片由台积电 N5 代工（业内估算）；Samsung HBM4 base 裸片用自家 4nm logic 工艺。三条路径在工艺成熟度、产能瓶颈、IP 整合度上各有差异。Samsung 路线的优势是 base 裸片不依赖台积电、产能上限不受台积电 N5 / N3 排队约束；劣势是 Samsung 4nm logic 工艺在 NVDA 端的认证流程要重新走一遍。

| HBM4 厂商 | base 裸片工艺 | 量产初期良率（业内估算）| 稳态良率（业内估算）| base 裸片产能瓶颈 |
|---|---|---:|---:|---|
| SK Hynix | 台积电 N12 → N5 | 90-93% | 95-97% | 受台积电 N5 配额约束 |
| Micron | 台积电 N5 | 90-93% | 95-97% | 受台积电 N5 配额约束 |
| Samsung | 自家 4nm | 业内估算 88-90% | 业内估算 93-95% | 受 Samsung Foundry 4nm 良率约束 |

> 来源：HBM4 base 裸片工艺分化综合 SK Hynix 2025-04 公告、Digitimes 2025-12 关于 HBM4E 报道、TrendForce 2024-12 关于 base 裸片工艺分化、TrendForce 2026-01-26 关于 Samsung 4nm 路线。三家厂良率均不公开，业内估算综合学术论文与卖方研报。
...
|---|---:|---:|---:|---|
| HBM3e 12-Hi（SK Hynix）| 50-60% | 80-85% | 6-9 个月 | SemiAnalysis 转引 |
| HBM3e 12-Hi（Samsung 二次量产后）| 40-50% | 70-75% | 9-12 个月 | KED Global / TrendForce 推算 |
...
良率曲线不是一条平滑上升的直线，而是 S 形。把 SK Hynix HBM3e 12-Hi 量产爬坡的月度良率拉出来（业内估算综合 SK Hynix 学术论文披露 + 卖方研报推演）：
...
> 来源：HBM3e 12-Hi 量产爬坡月度数据为业内估算，综合 SK Hynix 公开学术论文披露的工艺成熟度曲线 + Bernstein / Mizuho 卖方研报推演 + SemiAnalysis 转引。三家厂均不公开月度良率数据，本表为整理曲线。
...
S 曲线的另一种可能形态是卡死——良率在某个百分点（如 60%）反复震荡，无法继续爬升。Samsung HBM3e 12-Hi 第一、二次提交 NVDA 认证失败就是 卡死在 50-60% 良率 的状态。卡死的物理原因通常是工艺缺陷与材料学问题的混合——比如 Samsung 的 thermal performance issues 是 DRAM core 设计 + 制造工艺联合问题，单点优化解决不了，需要做 DRAM core 重新设计（即 Jun Young-hyun 主导的 redesign）。
...
CoWoS-L 大面积 interposer 翘曲问题不是 NVDA 一家的问题——Google TPU v7、Broadcom Meta MTIA v3、AWS Trainium 等所有大封装 ASIC 产品都共享同一组 CoWoS-L 工艺与良率挑战。把 CoWoS-L 在 2024-2026 期间的良率改善节奏列出来：
...
最敏感的设备是 ASML 的光刻机。ASML（荷兰，全球光刻设备主导供应商，2025 年 EUV 光刻机市占接近 100%）2025 全年净销售 €32.7B、Q4 净销售 €9.7B、Q4 毛利率 52.2%、全年毛利率 52.8%。ASML 2025 末在手订单（合同储备）€38.8B，对应交货周期 18-24 个月。NVDA / 台积电 / SK Hynix 现在下的设备订单，要等到 2027 年中或之后才能到货。

不只光刻机。深硅刻蚀机（Lam Research 与 Tokyo Electron 主导，用于 TSV 工艺）、铜电镀沉积设备（Lam Research / Applied Materials 主导）、高级封装量测设备（Camtek / Onto Innovation 主导）都在 18-24 个月的交期上。Lam Research 在 FY24 财报电话会上披露 "HBM packaging-related equipment revenue grew triple-digit percentages YoY"，把 HBM + CoWoS 的 TSV 工艺归在同一类设备；Camtek 在 2024-2025 公司业绩里多次披露 advanced packaging 是营收增长的最主要驱动——这两组设备厂的财务变化是 CoWoS / HBM 扩产节奏的领先指标。
...
|---|---|---|---|---|
| EUV 光刻机（HBM4 base 裸片 N3 用）| ASML | 18-24 月 | base 裸片 logic 工艺 | 是（HBM4 起新增） |
| KrF DUV 浸没式光刻机（CoWoS 65nm 用）| ASML + Canon | 12-18 月 | CoWoS 硅 interposer 65nm 工艺 | 部分瓶颈 |
| 深硅刻蚀机（TSV 用）| Lam Research + Tokyo Electron | 12-18 月 | TSV 通孔加工 | 是 |
...
> 来源：设备交期数据综合 ASML 季报披露 + Lam Research / AMAT / KLA 季报 + 业内研报。交期均为业内估算，不同型号、不同客户优先级下浮动 ±30%。
...
ASML 在手订单作为产业链领先指标，值得单独展开。ASML 2025 全年净销售 €32.7B、Q4 净销售 €9.7B、Q4 毛利率 52.2%。2025 末在手订单合同储备 €38.8B，对应交货周期 18-24 个月。
...
| 三家 HBM 厂（SK Hynix / Micron / Samsung）| 20-25% | 1a/1b nm DRAM + HBM4 base 裸片 |
| Intel + Samsung Foundry | 15-20% | 先进逻辑节点扩张 |
| 中国大陆客户 | 5-10% | 受 BIS 出口管制约束，主要是成熟节点 |
| 其他客户（GlobalFoundries / Micron 闪存等）| 10-15% | 各类 |

> 来源：ASML 在手订单客户分布为业内估算，综合 ASML 历年法说会披露 + 业内研报。ASML 不公开客户级订单分布。

ASML 在手订单的方向变化对 CoWoS / HBM 产能曲线的领先性约 18-24 个月——也就是说，ASML 在手订单在 2024 年下半年的同比变化对应 2026 年中以后的产能落地节奏。读者跟踪 ASML 季度财报里的合同储备数字与 China sales 占比，可以推演 2027-2028 全球先进制程产能的扩张节奏。
...
HBM 新 fab 比 CoWoS 厂更慢。HBM 新 fab 需要前道 DRAM 工艺产能 + TSV 工艺产能 + 堆叠工艺产能 + base 裸片工艺（HBM4 之后由台积电代工）四档协同。SK Hynix 在 2024-Q2 启动的 Cheongju M15X 新厂、2026 年初投产，从立项到首批 HBM3e/HBM4 良品出货时间表业内估算 24-30 个月。Samsung 计划 2026 年全年 HBM 总产能扩到 250K 晶圆 / 月，较 2025 年底的 170K 提升约 47%——这个扩产对应的 fab 建设决策在 2024 年就要做。
...
> 来源：HBM fab 扩产周期为业内估算，综合 SK Hynix Cheongju M15/M15X 建设时间表 + Samsung Pyeongtaek P3/P4 建设时间表 + Micron 2024 Idaho 新厂建设计划。各阶段耗时 ±20%。

27-42 个月是物理时间最长的一档。**SK Hynix 在 2024-Q2 启动的 Cheongju M15X 新厂从立项到首批 HBM3e/HBM4 良品出货时间表业内估算 24-30 个月**——SK Hynix 把这个周期压到下限是因为：(a) M15X 是 M15 的紧邻扩建，公用工程已经具备；(b) SK Hynix 在 HBM 工艺上的成熟度让良率爬坡周期缩短到下限 6 个月。即便如此，从 2024-Q2 立项到 2026 年初投产仍然要 20 个月，是物理时间下限。

Samsung 计划 2026 年全年 HBM 总产能扩到 250K 晶圆 / 月，较 2025 年底的 170K 提升约 47%——这个扩产对应的 fab 建设决策在 2024 年就要做。Samsung 用 P4 厂（Pyeongtaek 第四厂）部分产能转向 HBM4 + Cheonan HBM 后段封装新线协同实现这次扩产。
...
> 来源：四档时间表为综合台积电历史 fab 建设记录、SK Hynix / Micron / Samsung 公开披露的 HBM 量产时间表、ASML / Lam Research 设备交期披露、业内研报多源拼接。各档时间在不同厂区、不同工艺世代下有 ±20% 浮动。
...
|---|---|---|---|
| Lam Research | "HBM packaging-related equipment revenue grew triple-digit percentages YoY" | +100%+ | Lam Research FY24 财报电话会 transcript |
...
| ASML | EUV 在手订单 + 业务结构里 logic / HPC 客户占比上升 | 在手订单业内估算 +30%+ | ASML Q4 2025 财报 2026-01-28 |
| Applied Materials | advanced packaging 业务 + HBM 相关设备 | 业内估算 +40%+ | AMAT FY25 10-K |
...
2. **价格信号领先性**：设备厂在产业链上的定价能力比 NVDA 弱，但比台积电 / SK Hynix 稳定——设备厂的毛利率波动比产能波动小，因此在景气度变化时，设备厂的量信号比价信号更纯净。Lam Research 在 FY24 报 HBM 设备同比 +100%+，比 NVDA / 台积电单季营收的同比增速更直接反映了 HBM 物理产能的扩张节奏。

这一层产业链上下游的传导逻辑——CoWoS / HBM 扩产 → 设备厂订单 → 设备厂业绩——是第 3 章上游设备章已经展开的反共识洞察 上游设备不紧缺、但价值被低估的供给侧实证。设备厂在 2024-2025 同步出现业绩跃升，与台积电 / SK Hynix 同期产能扩张曲线相互验证。这是议题 3 物理紧缺真伪判断的第三组独立证据。
...
### Samsung HBM3e 12-Hi 三年认证时间线

Samsung 在 HBM3e 12-Hi 上的故事是客户认证墙最具代表性的案例。把时间线拉出来：

| 时点 | 事件 | 来源 |
|---|---|---|
| 2024-03 GTC 2024 | Jensen Huang 拿起 Samsung HBM3e 12-Hi 样品签 Jensen Approved | Reuters 2024-03 转 Bloomberg |
| 2024-Q3 | Samsung 第 1 次提交 12-Hi 通过 NVDA QS（Qualification Sample）流程，因热管理与 power consumption 不达标退回 | DigiTimes 2024-08 |
| 2024-Q4 | 第 2 次提交，再次退回 | The Korea Times 2024-12 |
| 2025-Q2 | 第 3 次提交，再次退回 | TrendForce / DigiTimes 2025-06-12 |
| 2025-05 | Samsung 半导体业务负责人 Jun Young-hyun 上任后主导 DRAM core redesign（解决 thermal performance issues） | KED Global 2025-09-19 |
...
| 2026-01 | Samsung 通过 NVDA HBM4 system-in-package 测试（11.7 Gb/s 超过 10 Gb/s 规格要求）| TrendForce 2026-01-26 |
| 2026-02 | Samsung 启动 NVDA / AMD 的 HBM4 出货 | TrendForce 2026-01-26 + Digitimes 2025-12-26 |
| 2026-06 | Samsung HBM4 full-scale supply | TrendForce 2026-01-26 |

> 来源：Samsung 认证时间线综合 Reuters / DigiTimes / KED Global / TrendForce / The Korea Times 多源拼接。各来源时点差 1-2 季，已按 Samsung 官方法说会披露 + 第三方多源校核取中位时点。

**从 Jensen Approved（2024-03）到真正通过 NVDA QS（2025-09），Samsung 用了 18 个月**。这 18 个月里 Samsung 半导体业务的财务后果非常重——同期 SK Hynix FY25 营业利润率 49%、Samsung DS（Device Solutions，半导体业务部门）FY25 营业利润率约 19%（KRW 24.9T 营业利润 / KRW 130.1T 营收 = 19.1%；来源：SK Hynix Q4 2025 新闻稿 2026-01-28 + Samsung Electronics 2025 全年业绩 2026-01）。这 30 个百分点的差距，几乎全部来自 HBM 业务的认证差距。

Samsung 认证延迟的内核不是工艺不行——Samsung DRAM 工艺历史上长期领先（从 1980 年代到 2010 年代一直是 DRAM 业的老大），TSV 工艺在 HBM2 时代也是 Samsung 首发，工程团队规模也不输 SK Hynix。**问题卡在 NVDA 在 production sample / long-term reliability validation 阶段对热管理与 power consumption 的现场测试不达标**——这一层需要 Samsung 在 NVDA 的客户端（超大规模云厂）数据中心实际部署运行 6-12 个月，验证现场失效率（FIT，Failures in Time，半导体可靠性失效率单位，1 FIT = 10 亿工作小时内 1 次故障；NVDA 对 HBM 的 FIT 要求通常在个位数量级）。这是 Samsung 在 HBM 上工艺储备充足但认证墙翻不过去的根因。
...
> 来源：NVDA HBM 认证四阶段框架综合 SK Hynix 技术白皮书、Micron 认证案例披露与 TrendForce 认证跟踪报道整理；NVDA 不公开正式流程文档。各阶段通过比例与耗时为业内估算，三家厂均不公开认证细节。

Samsung 在 HBM3e 12-Hi 上的故事就卡在 QS 这一关。QS 阶段的通过率 30-50%（业内估算）是认证流程里最严的一道，因为 NVDA 的 stress test 覆盖热循环 + 电压 margin + 长期 retention 三重测试。Samsung 工艺储备最强但仍然过不去，是因为 HBM3e 12-Hi 的热管理设计与 Samsung 自家 1a/1b nm DRAM 工艺的 retention 特性配合不好——这是一个跨工艺协同问题，不是单点优化能解决的。

### Samsung 18 个月延迟的财务后果与产业份额转移

Samsung 18 个月缺席的财务后果通过 HBM 份额转移传导到 SK Hynix 与 Micron。

| 时点 | SK Hynix HBM 市占 | Samsung HBM 市占 | Micron HBM 市占 | 其他 |
|---|---:|---:|---:|---:|
| 2024-Q2 | 50% | 41% | 5% | 4% |
| 2024-Q4 | 56% | 32% | 12% | — |
| 2025-Q2 | 62% | 17% | 21% | — |
...
Samsung 从 41% 跌到 17%（-24pp），这部分份额平均分配给 SK Hynix（+12pp）和 Micron（+16pp）。这是 Micron 从 HBM 市场配角变成主角的财务根因——Micron Q1 FY2026 Cloud Memory BU 单季营收 \$5.3B、同比 +100%，如果没有 Samsung 18 个月缺席，Micron 不可能在这个时间窗口里把 HBM 市占翻 4 倍。

**Samsung 案例对认证墙严苛性的最终证明**——即使 Samsung 这种工艺储备充足、营收规模 \$220B+ 的全球第二大半导体公司，在 NVDA 认证墙面前也要花 18 个月去解决；这件事的财务后果是直接的 ~\$10B 量级的营收损失（业内估算 18 个月 HBM 业务损失收入 \$8-12B）+ 半导体业务营业利润率从领先位置跌到落后位置 30pp（与 SK Hynix 对比）。这种成本量级在 NVDA 等客户的认证流程面前都不算讨价还价的资本。这是认证墙在产业研究里被反复低估的物理硬度。

### Micron HBM3e 12-Hi 弯道

与 Samsung 18 个月困局相反，Micron（美国，全球第三大 DRAM 厂，HBM 时代借 HBM3e 弯道进入 NVDA 主流分配）的故事是另一种类型。

Micron 在 2023 年下注 HBM3e 12-Hi（跳过 HBM3 8-Hi），把工程资源集中在 NVDA H200 上：

- 2024-02：Micron 用 24GB 8-Hi HBM3e 拿到 NVDA H200 量产订单
- 2024-09：Micron HBM3e 12-Hi（36GB stack）通过 NVDA 认证，成为 NVDA HBM3e 的 preferred vendor 之一
- 2026-03-16：Micron 在 GTC 2026 官方宣布 "in high-volume production of HBM4 designed for NVIDIA Vera Rubin"，规格 36GB 12-Hi、pin speed 超过 11 Gb/s、单 stack 带宽超过 2.8 TB/s

**Micron 没有工艺降维——它做的是把 HBM3 一步跳过、把客户认证资源 all-in HBM3e，用一次跳代换来了进 NVDA 供应链的机会**。Micron Q1 FY2026（2025-09 至 2025-11）Cloud Memory Business Unit 单季营收 \$5.3B、同比 +100%，非 GAAP 营业利润率从 FY2025 之前的 27% 跳到 FY2026 Q1 的 47%。

Samsung 与 Micron 两个案例放在一起读，能看清客户认证墙的非对称性——**Samsung 工艺储备最强但仍然要等 18 个月，Micron 工艺储备最弱但提前两年布局拿到了主流分配**。客户认证不是工艺问题，是客户跟你一起爬良率曲线的过程问题。

### NVDA / SK Hynix / Micron / Samsung 四方博弈结构

把 HBM 端的四方博弈结构画清楚。这不是简单的 NVDA 采购 HBM 关系，而是 NVDA + 三家 HBM 厂之间存在多层博弈：

| 关系对 | 博弈结构 | 关键变量 |
|---|---|---|
| NVDA ↔ SK Hynix | 长期战略合作（10 年绑定）| HBM4 base 裸片由台积电代工后绑定加深；SK Hynix 是 NVDA 议价权最弱的对手 |
| NVDA ↔ Micron | 战略备选（2 年关系）| Micron 借 HBM3e 弯道，获 NVDA 备选权；NVDA 用 Micron 制衡 SK Hynix |
| NVDA ↔ Samsung | 三年磨合（待评估）| Samsung 2025-09 通过认证，但市场份额仍偏低；NVDA 需多源风险管理 |
| SK Hynix ↔ Samsung | 国内竞争（韩国巨头同行）| 工艺竞赛 + 人才争夺 + 客户分配博弈 |
| Micron ↔ Samsung | 国际竞争（美韩对手）| 美国 CHIPS Act + 韩国 K-Chip Act 政策制衡 |

> 来源：四方博弈结构为综合分析，基于本章 §11.5 列出的认证案例 + 第 6 章 §3 客户认证墙详谈。

这套博弈结构的关键含义——**NVDA 在 HBM 端的议价权远弱于在 CoWoS 端**。CoWoS 只有台积电一家供应商，NVDA 的议价权完全依赖长期合作 + 预付款体系；HBM 端有三家供应商（HBM3e 时代 SK Hynix + Micron 两家有效，HBM4 时代三家），NVDA 可以做三方分配制衡。但 HBM 端的多源也意味着 NVDA 不能轻易切换供应商——每个供应商都要做 12-18 个月联合爬坡。

**博弈结构的最终决定者是认证墙**。Samsung 18 个月缺席不是因为 NVDA 不愿用、也不是因为价格谈不拢，而是因为 Samsung 工艺没过 NVDA 的 production sample 测试。认证墙作为最终决定者，让加供应商在 HBM 业务上不是议价工具，而是工艺合规问题。
...
| SK Hynix | 强 | 工艺成熟度 + 长期合作（10 年绑定）+ 主导市占 60%+ |
| Micron | 弱 → 中 | HBM3e 弯道获 NVDA 主供应链；议价权随市占爬升 |
| Samsung | 中 → 强（待评估）| 工艺储备强 + Samsung Foundry 4nm 自给 base 裸片 + 国内政策支持 |
...
HBM 端的认证墙在 CoWoS 端有对应的版本——台积电在 CoWoS 月度配额上对 NVDA / AMD / Broadcom / Google 等客户的分配博弈。CoWoS 不是均匀分配的市场，台积电在每个客户上的是否答应加单是非线性决策。
...
> 来源：CoWoS 客户配额数据综合 TrendForce 2025-08-29（Broadcom 2026 CoWoS 增订）、TrendForce 2025-12-15（MediaTek 7-fold CoWoS 增量）、Introl Blog 2025（NVDA CoWoS-L 70% 占比）、Tom's Hardware 2026-01-02 综合分析。客户配额为业内估算，台积电与客户均不官方披露 CoWoS 配额。与第 5 章 §5.3 共享同一组数字，本节集中讲分配博弈机制。

NVDA 在 CoWoS 上份额从 60-65% 缓慢下降到 50-55%，不是 NVDA 拿货能力下降——NVDA 的 CoWoS 长合约还在加单——而是 Broadcom 系（Google TPU + Meta MTIA + AWS Trainium 设计 OEM）的总采购量在更快地增长。MediaTek 拿到 Google v7e / v8e TPU 设计 OEM 之后，向台积电申请的 2027 年 CoWoS 配额从 2026 年的约 20K 晶圆跃升到 150K 晶圆 / 年（即月度等效 12.5K 晶圆/月，来源：TrendForce 2025-12-15）——这是单一项目级别的产能挤占。
...
| Broadcom Meta MTIA | CoWoS-L | \$2,500-3,000 | 55% | \$1,375-1,650 |
...
3. **变种切分的非互换性**：CoWoS-S 与 CoWoS-L 是两条不能轻易互换的产线——设备配置、工艺参数、人才结构都不同（详见第 5 章 §5.3）。台积电在 2025-12-08 被 TrendForce 报道 CoWoS-L/S Reportedly Fully Booked —— 两条线都满载，但满载客户结构不一样：CoWoS-S 的客户结构里 H100 / H200 / MI300 占比高，CoWoS-L 的客户结构里 B200 / B300 / Google TPU v7 / Broadcom Meta MTIA v3 占比高。NVDA 在 2025 年拿走台积电 CoWoS-L 70%+ 配额。

### 认证墙的经济学根源：co-located 爬坡 learning

把 Samsung 18 个月、Micron 弯道、台积电客户分配三个案例拼起来，能看出客户认证墙的经济学根源是 Pisano-Shih 在 2009 年《Restoring American Competitiveness》论文里讲的 co-located 爬坡 learning——制造业的真正壁垒不是单点工艺，而是工程师跟客户工程师在量产爬坡阶段反复迭代积累的过程知识（tacit knowledge）。
...
> 来源：DDR5 与 HBM 对照综合 JEDEC 规范 + 三家 HBM 厂公开认证流程披露 + SK Hynix / Micron / Samsung 季报 + 业内研报。
...
co-located 爬坡 learning 的另一层含义是——**认证不可以并行**。Samsung 不能同时在 NVDA / AMD / Google 三个客户那里同步完成 HBM3e 12-Hi 认证——每个客户的认证流程都需要客户工程师的现场配合、长期可靠性数据、定制 base 裸片的 IP 验证。Samsung 同时启动多客户认证只会让每条认证线的工程师配置稀释。扩产能 = 加 fab 在 HBM 上不成立的更深层原因就落在这里——产能扩张要先过客户认证这道墙。

把 Pisano-Shih 框架套到 CoWoS 上结论一样。台积电与 NVDA 的 CoWoS 合作可以追溯到 2014-2015 P100 时代（NVDA Tesla P100 用 HBM2 + CoWoS 是 SK Hynix + 台积电联合首发）。台积电与 NVDA 的工艺协同积累在 10 年时间维度上，AMD 与台积电的 CoWoS 协同从 MI100（2020）开始，Broadcom 与台积电的 CoWoS 协同从 2022 年 Google TPU v4 开始。**新客户进入台积电 CoWoS 主供应链需要 6-12 个月的工艺协同爬坡**——这是台积电在 NVDA / AMD / Broadcom 之间分配 CoWoS 配额时，新客户加单不能像现货市场那样快速消化的原因。
...
| **认证稀缺**（有效供给减半）| ~25% | HBM3e 12-Hi 期间三家厂里只有 SK Hynix + Micron 两家通过 NVDA 认证（Samsung 缺席 18 个月），有效供给减半，需方议价权丧失 |
...
**工艺代差占 25% 的支撑**：
- 1z nm → 1a nm → 1b nm 三代 DRAM 工艺切换，每代晶圆 cost 上升 8-12%（业内估算综合 SK Hynix / Micron 工艺成本披露）
- 三代累计晶圆 cost 上升约 30%，对应 \$/stack 涨幅约 25-30%
- 这一项在 Bernstein 2024-Q2 卖方研报里有独立估算（25-30%），与本表权重一致

**认证稀缺占 25% 的支撑**：
- HBM3e 12-Hi 期间 Samsung 缺席 18 个月（2024-03 至 2025-09），意味着这 18 个月里 NVDA HBM3e 12-Hi 三家供应里只有 SK Hynix + Micron 两家有效
...
- 定制版本 ASP 比标准版高 30-50%（业内估算，来源：SK Hynix Q4 2025 法说会管理层表态 + Morgan Stanley 卖方研报）
- 但 custom HBM 在 HBM3e 时代占比有限（业内估算 < 30%），合计贡献约 10%

> 来源：四因素的多源交叉综合 Bernstein 2024-Q2、Mizuho 2024-Q3、Morgan Stanley 2025-Q1 卖方研报 + SK Hynix / Micron / Samsung 公开法说会。每一项的独立估算与本表权重在 ±5pp 区间内一致。
...
| HBM3e 12-Hi 稳态良率 | SK Hynix 80-85% / Samsung 70-75% / Micron 70-80% | 良率串联损失，有效供给减少 15-25% |
| HBM 三家通过 NVDA 12-Hi 认证 | SK Hynix 2024-Q2 / Micron 2024-09 / Samsung 2025-09 | Samsung 缺席 18 个月，有效供给减半 |
...
- 价格涨 3-4 倍不是 NVDA 单方面营销——SK Hynix FY25 营业利润率 49%、Micron Q1 FY26 营业利润率 47%——HBM 厂同步赚到这个价格，证明价格是供需失衡的真实出清结果。
...
把这五条放在一起读——**结构性物理紧缺真实存在，至少到 2026-Q4 之前无法被加产能消除**。这是议题 3 的供给侧裁决，也是第 12 章「2027 拐点」反共识立场的供给侧基础。第 12 章给出的紧缺有窗口判断不与本章矛盾——窗口的开启正是由本章列出的四因素中弹性最高的那个（HBM 客户认证墙在 Samsung 2025-09 通过后开始松动）启动的。
...
|---|---|---|---|
| HBM 厂利润率没有同步跃升 | 价格上涨被供应商让利 | SK Hynix FY25 营业利润率 49%、Micron Q1 FY26 47% | 反例不成立，紧缺真实 |
| 三家 HBM 厂同步生产但 NVDA 拒收 | 供应充足但 NVDA 人为限制 | Samsung 多次提交被 NVDA 退回是质量问题，非人为限制；Micron 通过认证后立即获主供应链 | 反例不成立，紧缺真实 |
...
> 来源：综合 NVDA FY26 财报 + SK Hynix Q4 2025 + Micron Q1 FY26 + 四家超大规模云厂 2026 FY 指引法说会 + TrendForce / SemiAnalysis / Bernstein 多份研报。

四个反例条件全部不成立，意味着紧缺真实存在是经得起反向校验的判断。这是本章对议题 3 的最终供给侧答案。

下一节把这条供给侧曲线翻译成 NVDA 毛利率的传导测算。

## 11.7 瓶颈缓解对 NVDA 毛利率的传导：敏感度矩阵

本节给出一个明确边界的事——HBM 单 stack 价格与 CoWoS 利用率两个供给侧变量在不同假设下对 NVDA BOM 毛利率的传导测算。

**段内严格 commentary-only**——给敏感度矩阵但不下 NVDA 估值过高 / 过低结论（留第 30 章）；不讨论持仓；不给具体股价目标。本节是反共识 #5（客户集中度反身性）在产业链供给侧的首次量化伏笔，与第 14 章（客户集中度反身性）、第 29 章（周期定位）、第 30 章（设备商型估值模板）共同输入。涉及具体公司估值的判断仅用「市场报价」措辞。
...
### 为什么是 NVDA 毛利率而不是 SK Hynix 毛利率

本节做的是瓶颈缓解对 NVDA 毛利率的传导测算——这里要先解释为什么把测算落在 NVDA 毛利率而不是 SK Hynix / Micron / 台积电毛利率。

HBM 与 CoWoS 是 NVDA 的成本，是 SK Hynix / 台积电的营收。瓶颈缓解（HBM 价格下降 + CoWoS 利用率下降）对 NVDA 毛利率是正向（成本下降）、对 SK Hynix / 台积电毛利率是反向（营收 / 利用率下降）。两个方向同时存在，本节选择测算 NVDA 是因为：

1. **NVDA 在产业链上的市值占比远高于上游**——NVDA 2026-05 市值 \$5T+ 量级，SK Hynix + 台积电 + Micron 合计市值业内估算约 \$2T 量级。NVDA 估值对市场总市值的影响是上游三家合计的 2.5 倍以上。
2. **NVDA 毛利率传导的反身性最强**——5 客户集中度 40%（业内估算）让 NVDA 在瓶颈缓解时面临客户议价反向施压，反身性传导链是 NVDA 估值的核心 fragility。SK Hynix / 台积电在瓶颈缓解时的毛利率下行是线性的，没有反身性放大。
3. **NVDA 是议题 3 的市场焦点**——「算力紧缺真伪」的讨论焦点是 NVDA 估值，不是 SK Hynix / 台积电。本节把测算落在 NVDA 是为了直接回应议题 3 的市场关切。

SK Hynix / 台积电毛利率受瓶颈缓解的反向传导（即瓶颈缓解 → SK Hynix / 台积电利润率下行）会在第 29 章 §29.6 + 第 30 章五种估值模板章里以独立测算的方式展开。本节只测 NVDA 一端。
...
**第二层，温和缓解情景（HBM \$250、CoWoS 90%，对应 2027 上半年情景）**：BOM 毛利率 +0.8pp 到 82.8%。这对应第 12 章 §12.3 给出的 HBM4 三家同步爬坡 + Samsung 重获主流分配的第一次结构性缓解——市场对 NVDA 公司层 gross margin 的报价含义业内估算正面 +0.5-1pp（公司层 75% 区间）。

**第三层，深度缓解情景（HBM \$200、CoWoS 80%，对应第 29 章 §29.6 列出的页岩油式崩盘情景）**：BOM 毛利率 +1.7pp 到 83.7%。但这种情景对应的是供给侧深度过剩，反身性会把 ASP 拉下来——即 GB200 ASP 从 \$75K 跌到 \$55-65K，毛利率提升会被 ASP 下降部分抵消甚至反转。这种二阶反身性传导本测算未单独建模，留第 14 章 + 第 30 章展开。
...
这是第 12 章 §12.4 给出的第一次结构性缓解情景。HBM 单 stack 价格回落到 \$250（合约价 -17%），CoWoS 利用率从满产降到 90%。BOM 毛利率提升到 82.8%（+0.8pp）。反身性传导 70% 系数下，公司层 gross margin 提升约 +0.5pp 到 75.5%（在第 29 章 §29.10 公司层卖方共识 75-77% 区间内）。这个情景对应第 12 章 §12.7 三个早期预警信号中至少一个触发（H100 现货价跌破 \$2.5/hr 或 Samsung HBM3e 重获主流分配）。
...
把三种情景串起来读，能看出 §11.7 矩阵实际上是第 12 章 / 第 29 章 / 第 30 章三章共同的供给侧情景输入。本章不下结论说哪种情景概率最大，而是把三种情景的物理触发条件与传导链路写清楚，供第 30 章估值模板章的 base / bull / bear 三档使用。
...
把这一节关键含义压一行：**HBM 单 stack 价格与 CoWoS 利用率两个供给侧变量的边际变化，对 NVDA BOM 毛利率有可量化的传导路径**。瓶颈缓解的方向与时点（第 12 章给出 2026-Q4 至 2027-Q2 的物理时间窗口）会在 NVDA 估值模型里转化成毛利率假设的修正。这是产业链供给侧 → NVDA 估值的传导链路，是第 30 章五种估值模板章里设备商型估值模板的核心输入之一。
...
4. 客户认证墙把工艺已经能做与产能给到客户的距离扩大到 12-18 个月（Samsung 案例：18 个月）。
...
- 2027-Q4 是 §11.2 三家 HBM 同步爬坡 + Samsung full-scale supply（2026-06 起）后 12-18 个月的稳态有效供给时点；
...
| SK Hynix / Micron / Samsung HBM4 出货量 | 季度（三家法说会后 1-2 周内）| 各家季报 + TrendForce 月报 | 合计季度出货低于业内估算 80% 黄色预警 |
| ASML EUV 在手订单（合同储备）| 季度 | ASML 季报 | 季度环比首次下降黄色预警 |
...
**第 29 章接本章 §11.6**：第 29 章 §29.6 页岩油式崩盘情景对应本章可证伪条件中 A + B 同时触发的极端情况。第 29 章把周期定位问题翻译成时间维度，本章给出的是物理学维度的产能曲线作为输入。
...
|---|---|---:|---|
| 紧缺完全是营销叙事 | 物理产能充足，价格由 NVDA 单方面操纵 | < 5% | SK Hynix / Micron 利润率同步跃升、Mag7 资本支出用现金支付 |
...
本章给出的是物理学维度——四因素叠加证明物理紧缺真实存在。下一章第 12 章把这条物理曲线翻译成时间维度——**2027 拐点 + 三个预警信号 + Akerlof 二手市场反向应用**。第 12 章 §12.7 给出三个可证伪的早期信号（H100 现货价跌破 \$2.5/hr、Hopper 二手挂牌价跌破新机 60%、Samsung HBM3e 12-Hi 重获 NVDA 主流分配），与本章 §11.8 的双阈值证伪条件共同构成本书对议题 3「算力紧缺真伪」的完整答辩体系。
...
| 第 3 章上游设备 | Lam Research / Camtek HBM 设备收入暴涨 | 本章 §11.4 设备厂领先指标证据 |
...
| 第 31 章 12 议题答辩 | 议题 3 算力紧缺真伪的主答辩位 | 本章是议题 3 的供给侧裁决（前置）|

> 来源：跨章节联动设计，确保本书在数据口径、时点、判断方向上一致。

这套跨章联动的设计保证了本书在产业研究 + 投资视角上的内在一致性——同一组数据（如 HBM 单 stack 价格、CoWoS 月产能、Samsung 18 个月延迟）在不同章节从不同角度切入，但口径与方向保持统一。读者在任何一章发现的数据点都可以在其他章节找到独立佐证。
...
第四，设备 + 厂房扩产周期是 24-36 个月的物理时间常数（ASML EUV 交期 18-24 个月 + 台积电厂房 1.5-2 年 + HBM fab 24-30 个月 + 良率爬坡 6-9 个月），无法被加钱跨越。

第五，客户认证准入墙把工艺已经能做与产能给到客户的距离扩大到 12-18 个月——Samsung HBM3e 12-Hi 通过 NVDA 认证用了 18 个月，同期 SK Hynix 与 Micron 拿走有效供给的几乎全部增量。
...
§11.7 敏感度矩阵 + §11.8 双阈值证伪条件是本章交给后续章节的两个量化接口——前者是 NVDA 估值的供给侧情景输入（第 30 章），后者是周期定位监测点（第 29 章 + 第 12 章 + 第 14 章）。本章在产业研究方法论上做了一次把营销叙事翻译成物理曲线的尝试——把算力紧缺这个被反复使用的词，从一个市场情绪标签还原成可分解、可监测、可证伪的四组数字。这是本章给读者的工具：以后再听到算力紧缺这个词，应该立刻反问自己 CoWoS 月产能在哪？HBM 哪家通过认证了？设备厂订单同比多少？利用率多少？——这四个问题的答案决定了紧缺是真还是假，而不是任何一家公司管理层的法说会原话。

下一章第 12 章把物理学翻译成时间——2027 拐点 + 三个预警信号 + Akerlof 二手市场反向应用。第 12 章会在本章物理基础上向前推一步——给出紧缺有窗口的反共识立场 + 三个可量化监测的早期预警信号 + 一组立此存照的可证伪承诺。两章合起来，是本书对议题 3「算力紧缺真伪」的完整产业研究答辩——本章给基线，第 12 章给拐点。
