...
议题 2 与上一章议题 1 形成机制—信号—周期三层归位：上一章答辩的是超大规模云厂自己拿不拿得出钱，这里答辩的是中间这一圈钱的流向是不是真的有终端，周期定位章把两件事合起来收束周期阶段判断。这里只立证据 + 给条件式判断，AI 是不是 dotcom 2.0 的定性收束放在全书议题答辩章。
...
周期定位章 §29.9 把同一现象作为周期顶部信号再次收束——绿区（< 5%）/ 黄区（5-15%，当前位置）/ 红区（> 15%，监管开始限制）。本章讲机制、周期定位章把它读作周期信号、议题答辩章给定性结论，三处共同支撑本书对议题 2 形态相似 / 结构不同的完整答辩。
...
下一章把视角拉到全球格局——美国主导体系（技术 + 资本 + 规则三位一体）是 AI 循环交易能形成的宏观容器。技术层面：NVDA 的 GPU 设计 / 台积电的封装 / SK 海力士的 HBM 都在美国主导的供应链网络内；资本层面：循环交易里出现的所有大额股权 / warrant / 框架协议都在美国主导的资本市场结构（NYSE / NASDAQ / SEC 披露体系 / 美国 LP 主导的一级市场）内运行；规则层面：SEC 8-K 实时披露要求 + 美国 GAAP 关联交易披露体系 + DOJ / FTC 反垄断关注，让循环交易嫌疑被市场广泛讨论但又没有立即被监管叫停。证伪条件 2（vendor financing 信贷化）触发的早期信号会经由 NVDA 10-K 附注披露——这一披露透明度本身是美国主导体系的产物。

下一章把这件事展开成全书第五部全球格局的开篇——AI 算力供应链的现实结构、美元 / 美元资本对全球 AI 资本支出节奏的定价权、出口管制如何改写全球算力配置 / 中国侧路径如何在主导体系外形成平行链。循环交易问题在这一视角下不再只是 NVDA / OpenAI 关联交易的会计现象，而是美国主导体系下算力—资本—规则三者紧密耦合的必然形态——监管对披露的依赖、市场对叙事的包容、资本对未来现金流的折算共同形成软约束框架。

---

> **免责声明**
>
> 本章涉及具体公司（英伟达 / OpenAI / Oracle / CoreWeave / Microsoft / AMD / Google / AWS / Anthropic / xAI / Lucent / Nortel / Global Crossing 等）的财务分析、循环交易判断、产业判断与议题 2 答辩立场，仅为作者基于公开信息的产业研究结果，**不构成任何投资建议**。市场有风险，投资决策应基于读者自身的独立判断和专业咨询。
>
